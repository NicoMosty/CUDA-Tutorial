...
# Let’s Dive into CUDA Code: Practical Examples
 <img src="../images/QR.png" style="position: absolute; top: 30%; left: 70%; width: 25%;">


[Colab Notebook](https://colab.research.google.com/drive/1Nl3Ab0H21iQK1oiZpf501KyGj1RXHWaY#scrollTo=giiucWvb0dyg){style="position: absolute; top: 420px; left: 665px; font-size: 40px;"}



  <div style="position: absolute; top: 20%; left: 5%; width: 60%; border: 1px solid #ccc; padding: 7px; text-align: left; overflow: auto; font-size: 12px;">
